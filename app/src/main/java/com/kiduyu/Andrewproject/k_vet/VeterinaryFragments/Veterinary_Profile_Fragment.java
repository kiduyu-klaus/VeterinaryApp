...
public class Veterinary_Profile_Fragment extends Fragment  {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       View view=  inflater.inflate(R.layout.fragment_vet_profile,container,false);
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    filereference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            RootRef = FirebaseDatabase.getInstance().getReference().child("Farmers").child(Prevalent.currentOnlineUser.getPhone());
